...
mod tests {
    ...
    mod set_flags__get_flags {
        ...
        fn sets_flags() {
            ...
            nia_assert_equal(OBJECT_VALUE_WRAPPER_FLAGS_DEFAULT, value_wrapper.get_flags());
        ...
        fn returns_error_during_configuring_of_not_configurable_binding() {
            ...
            nia_assert(value_wrapper.set_flags(OBJECT_VALUE_WRAPPER_FLAGS_DEFAULT).is_err());
            nia_assert_equal(flags, value_wrapper.get_flags());
        }
    }
    ...
    mod set_flag__get_flag {
        ...
        fn gets_and_sets_flags__gets_flags() {
            ...
            nia_assert_equal(true, value_wrapper.get_flag(OBJECT_VALUE_WRAPPER_FLAG_INTERNABLE));
            nia_assert_equal(true, value_wrapper.get_flag(OBJECT_VALUE_WRAPPER_FLAG_WRITABLE));
            nia_assert_equal(true, value_wrapper.get_flag(OBJECT_VALUE_WRAPPER_FLAG_ENUMERABLE));
            nia_assert_equal(true, value_wrapper.get_flag(OBJECT_VALUE_WRAPPER_FLAG_CONFIGURABLE));

            nia_assert_equal(Ok(()), value_wrapper.set_flag(OBJECT_VALUE_WRAPPER_FLAG_INTERNABLE, false));
            nia_assert_equal(Ok(()), value_wrapper.set_flag(OBJECT_VALUE_WRAPPER_FLAG_WRITABLE, false));
            nia_assert_equal(Ok(()), value_wrapper.set_flag(OBJECT_VALUE_WRAPPER_FLAG_ENUMERABLE, false));
            nia_assert_equal(Ok(()), value_wrapper.set_flag(OBJECT_VALUE_WRAPPER_FLAG_CONFIGURABLE, false));

            nia_assert_equal(false, value_wrapper.get_flag(OBJECT_VALUE_WRAPPER_FLAG_INTERNABLE));
            nia_assert_equal(false, value_wrapper.get_flag(OBJECT_VALUE_WRAPPER_FLAG_WRITABLE));
            nia_assert_equal(false, value_wrapper.get_flag(OBJECT_VALUE_WRAPPER_FLAG_ENUMERABLE));
            nia_assert_equal(false, value_wrapper.get_flag(OBJECT_VALUE_WRAPPER_FLAG_CONFIGURABLE));

            nia_assert(value_wrapper.set_flag(OBJECT_VALUE_WRAPPER_FLAG_INTERNABLE, false).is_err());
            nia_assert(value_wrapper.set_flag(OBJECT_VALUE_WRAPPER_FLAG_WRITABLE, false).is_err());
            nia_assert(value_wrapper.set_flag(OBJECT_VALUE_WRAPPER_FLAG_ENUMERABLE, false).is_err());
            nia_assert(value_wrapper.set_flag(OBJECT_VALUE_WRAPPER_FLAG_CONFIGURABLE, false).is_err());
        }
    }
    ...
    mod set_internable__is_internable {
        ...
        fn gets_and_sets_internable_flag() {
            let mut object_value_wrapper = ObjectValueWrapper::new(
                Value::Integer(0)
            );
