...
pub fn define_action_mouse_relative_move<S>(
...
mod tests {
    ...
    #[test]
    fn adds_mouse_relative_move_actions_to_action_alist() {
        ...
        for (action_name, x, y, expected) in specs {
            ...
            nia_assert_is_ok(&define_action_mouse_relative_move(
                &mut interpreter,
                action_name,
                x,
                y,
    ...
    fn returns_error_when_action_with_that_name_already_defined() {
        ...
        crate::utils::assert_generic_execution_error(
            &define_action_mouse_relative_move(
                &mut interpreter,
                "mouse-relative-move-1",
                100,
                100,
