...
pub fn read_property_symbol_id_from_property_descriptor(
    ...
    let property_symbol_id = if let Some(value) = interpreter.get_object_property(
...
pub fn read_property_value_from_property_descriptor(
    ...
    let value = if let Some(value) = interpreter.get_object_property(
        property_descriptor_object_id,
        value_symbol_id
    )? {
        value
...
mod tests {
    ...
    fn defines_new_property() {
        ...
        let specs = vec!(
            ("(let ((obj {})) (object:define-property! obj {:name \"prop\"}) obj)", "{:prop nil}"),
            ("(let ((obj {})) (object:define-property! obj {:name 'prop}) obj)", "{:prop nil}"),
            ("(let ((obj {})) (object:define-property! obj {:name :prop}) obj)", "{:prop nil}"),

            ("(let ((obj {})) (object:define-property! obj {:name \"prop\" :value 1}) obj)", "{:prop 1}"),
            ("(let ((obj {})) (object:define-property! obj {:name 'prop :value 1}) obj)", "{:prop 1}"),
            ("(let ((obj {})) (object:define-property! obj {:name :prop :value 1}) obj)", "{:prop 1}"),
        );
