...
pub fn infect(interpreter: &mut Interpreter) -> Result<(), Error> {
    ...
    let funcs: Vec<(&str, fn(&mut Interpreter, EnvironmentId, Vec<Value>) -> Result<Value, Error>)> = vec!(
        ("define-property!", define_property_mark::define_property_mark),
        ("delete-property!", delete_property_mark::delete_property_mark),
        ("freeze!", freeze_mark::freeze_mark),
        ("make", make::make),
        ("get", get::get),
        ("get-property-descriptor", get_property_descriptor::get_property_descriptor),
        ("get-proto", get_proto::get_proto),
        ("is-configurable?", is_configurable_question::is_configurable_question),
        ("is-enumerable?", is_enumerable_question::is_enumerable_question),
        ("is-frozen?", is_frozen_question::is_frozen_question),
        ("is-internable?", is_internable_question::is_internable_question),
        ("is-writable?", is_writable_question::is_writable_question),
        ("set-configurable!", set_configurable_mark::set_configurable_mark),
        ...
        ("new", new::new),
        ("update-property!", update_property_mark::update_property_mark),
    );
