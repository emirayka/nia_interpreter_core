...
pub fn delete_property_mark(
    ...
    let object = interpreter.get_object_mut(
        object_id
    )?;

    if !object.has_property(property_symbol_id) {
        return Error::generic_execution_error(
            "Object has not property."
        ).into();
    }
...
mod tests {
    ...
    fn deletes_property() {
        ...
        let specs = vec!(
            ...
            ("(let ((obj {:prop 1 :prop-2 2})) (object:delete-property! obj \"prop\") obj)", "{:prop-2 2}"),
            ("(let ((obj {:prop 1 :prop-2 2})) (object:delete-property! obj :prop) obj)", "{:prop-2 2}"),
            ("(let ((obj {:prop 1 :prop-2 2})) (object:delete-property! obj 'prop) obj)", "{:prop-2 2}"),

            ("(let ((obj {:prop 1 :prop-2 2})) (object:delete-property! obj \"prop-2\") obj)", "{:prop 1}"),
            ("(let ((obj {:prop 1 :prop-2 2})) (object:delete-property! obj :prop-2) obj)", "{:prop 1}"),
            ("(let ((obj {:prop 1 :prop-2 2})) (object:delete-property! obj 'prop-2) obj)", "{:prop 1}"),
        );
