...
mod tests {
    ...
    fn returns_mapped_list() {
        ...
        let pairs = vec!(
            ("(list:filter (function (lambda (value) (eq? (% value 2) 0))) '(1 2 3 4 5))", "'(2 4)"),
            ("(list:filter (function (lambda (value) (eq? (% value 2) 1))) '(1 2 3 4 5))", "'(1 3 5)"),
        );
    ...
    fn returns_invalid_argument_error_when_predicate_returns_not_a_boolean() {
        ...
        let code_vector = vec!(
            "(list:filter (function (lambda (value) 1)) '(1 2 3 4 5))",
        );
