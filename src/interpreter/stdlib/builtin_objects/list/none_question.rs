...
mod tests {
    ...
    fn executes_function() {
        ...
        let pairs = vec![
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '())",
                "#t",
            ),
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '(1))",
                "#t",
            ),
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '(1 2))",
                "#f",
            ),
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '(1 2 3))",
                "#f",
            ),
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '(1 2 3 4))",
                "#f",
            ),
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '(2))",
                "#f",
            ),
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '(2 4))",
                "#f",
            ),
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '(1))",
            ...
            (
                "(list:none? (function (lambda (value) (eq? (% value 2) 0))) '(1 3))",
                "#t",
            ),
        ];
    ...
    fn returns_invalid_argument_error_when_predicate_returns_not_a_boolean() {
        ...
        let code_vector = vec!["(list:none? (function (lambda (value) 1)) '(1 2 3 4 5))"];
    ...
    fn returns_invalid_argument_count_error_when_incorrect_count_of_arguments_were_passed() {
        ...
        let code_vector = vec!["(list:none?)", "(list:none? 1)", "(list:none? 1 2 3)"];
