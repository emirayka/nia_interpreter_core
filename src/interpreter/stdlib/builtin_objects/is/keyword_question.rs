...
mod tests {
    ...
    fn returns_true_when_an_keyword_was_passed() {
        ...
        let pairs = vec![("(is:keyword? :keyword)", Value::Boolean(true))];
    ...
    fn returns_false_when_not_an_keyword_was_passed() {
        ...
        let pairs = vec![
            ("(is:keyword? 1)", Value::Boolean(false)),
            ("(is:keyword? 1.1)", Value::Boolean(false)),
            ("(is:keyword? #t)", Value::Boolean(false)),
            ("(is:keyword? #f)", Value::Boolean(false)),
            ("(is:keyword? \"string\")", Value::Boolean(false)),
    ...
    fn returns_invalid_argument_count_error_when_incorrect_count_of_arguments_were_passed() {
        ...
        let code_vector = vec!["(is:keyword?)", "(is:keyword? 1 2)"];
