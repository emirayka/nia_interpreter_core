...
pub fn send_mouse_button_down(
    ...
    let mouse_button_down_symbol_value =
        interpreter.intern_symbol_value("mouse-button-down");
...
mod tests {
    ...
    fn adds_action_to_action_list() {
        ...
        let pairs = vec![
            ("--actions", "'()"),
            (
                "(action:send-mouse-button-down 2) --actions",
                "'((mouse-button-down 2))",
            ),
            (
                "(action:send-mouse-button-down 3) --actions",
                "'((mouse-button-down 3) (mouse-button-down 2))",
            ),
        ];
