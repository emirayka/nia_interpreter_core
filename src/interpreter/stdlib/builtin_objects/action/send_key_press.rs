...
pub fn send_key_press(
    ...
    let key_press = interpreter.vec_to_list(vec![key_press_symbol_value, Value::Integer(key_code)]);
...
mod tests {
    ...
    fn returns_invalid_argument_count_error_when_incorrect_count_of_arguments_were_passed() {
        ...
        let code_vector = vec!["(action:send-key-press)", "(action:send-key-press 1 2)"];
