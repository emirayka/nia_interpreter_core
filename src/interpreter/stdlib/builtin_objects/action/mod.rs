...
pub fn infect(interpreter: &mut Interpreter) -> Result<(), Error> {
    ...
    let bindings: Vec<(&str, BuiltinFunctionType)> = vec!(
        ...
        ("send-mouse-button-down", send_mouse_button_down::send_mouse_button_down),
        ("send-mouse-button-press", send_mouse_button_press::send_mouse_button_press),
        ("send-mouse-button-up", send_mouse_button_up::send_mouse_button_up),
