...
pub fn send_mouse_move_to(
    ...
    library::add_value_to_root_list(interpreter, "--actions", mouse_move_to)?;
...
mod tests {
    ...
    fn adds_action_to_action_list() {
        ...
        let pairs = vec![
            ("--actions", "'()"),
            (
                "(action:send-mouse-move-to 2 3) --actions",
                "'((mouse-move-to 2 3))",
            ),
            (
                "(action:send-mouse-move-to 3 4) --actions",
                "'((mouse-move-to 3 4) (mouse-move-to 2 3))",
            ),
        ];
